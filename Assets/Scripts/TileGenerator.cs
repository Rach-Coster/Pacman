...
public class TileGenerator : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GenerateBorderRight();
        GenerateBorderTop();
        GenerateBorderBottom(); 
        
        GenerateLevelTopLeft();
        GenerateLevelTopRight();
        GenerateLevelBottomLeft();
        GenerateLevelBottomRight();
        GenerateGhostBorder();
    ...
    void GenerateDots()
    {
        for (var i = 0; i < height; i++)
        {
            for (var j = 0; j < width; j++)
            {
                ...
                if (i == 1 && j > 1 && j < 9)
                {
                    Instantiate(dot, new Vector2(cellPosition.x, cellPosition.y), Quaternion.identity);
                }
